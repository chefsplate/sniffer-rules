<?php
class ChefsPlate_Sniffs_Classes_PropertyDeclarationSniff extends PSR2_Sniffs_Classes_PropertyDeclarationSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        // TODO: We should REALLY switch over to camelCaps format, for now this check is disabled...
